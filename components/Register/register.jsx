...
<div style={{display:"flex", justifyContent:"center" , alignItems:"center"}}>
                       <input style={{width: "10px", marginRight:"10px" , cursor:"pointer"}} type="checkbox" name="terms" value="j'accepte la politique de confidentialité"   ref={register({required : true})}/>
                       <label style={{fontSize:"15px"}} for="terms" > j'accepte <a href="/terms.pdf" target="_blank" style={{color:"#0c97b4" , textDecoration:"underline #0c97b4"}}>la politique de confidentialité</a></label><br></br>
                       </div>

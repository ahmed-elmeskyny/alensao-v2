    ...
    <div className={styles.treeContainer}>
      ...
      <div className={styles.profilContainer}>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/abbaci.jpeg)" }}
          ></div>
          <div className={styles.name}>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/sanaa.jpeg)" }}
          ></div>
          <div className={styles.name}>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/kamal.jpeg)" }}
          >
            {" "}
          </div>
          <div className={styles.name}>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/omar.jpeg)" }}
          ></div>
          <div className={styles.name}>
            <h3>NADI Omar</h3>
            <p>Membre de l'ALENSAO</p>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/samir.jpg)" }}
          ></div>
          <div className={styles.name}>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/jihane.jpeg)" }}
          ></div>
          <div className={styles.name}>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/hadil.jpeg)" }}
          ></div>
          <div className={styles.name}>
            <h3>MHAMDI Hadil</h3>
            <p>Membre de l'ADE</p>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/meftouhi.jpeg)" }}
          ></div>
          <div className={styles.name}>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/ismail.jpg)" }}
          ></div>
          <div className={styles.name}>
            <h3>DINE Ismail</h3>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/mahmoud.jpeg)" }}
          ></div>
          <div className={styles.name}>
            <h3>AZDAD Mahmoud</h3>
            <p>Ancien Membre de l'ADE</p>
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{
              backgroundImage: "url(/ahmed.jpeg)",
        ...
        <div className={styles.profile}>
          <div
            className={styles.pdp}
            style={{ backgroundImage: "url(/soufiane.jpeg)" }}
          ></div>
          <div className={styles.name}>

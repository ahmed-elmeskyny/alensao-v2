  ...
  return (
    <div >
      <Head>
        ...
        <meta property="og:description" content="Un nouveau concept , en collaboration entre l'ALENSAO et l'ADE, d'un magazine bimestriel couvrant les événements au sein de l'ENSAO. Reportages, articles, news... soyez aux aguets pour notre nouvelle revue : MagEnsao!"></meta>
      </Head>
